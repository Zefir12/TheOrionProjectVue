...
<template>
    <div class="sidebar" :class="{ 'sidebar-hidden': !sidebarStore.sidebarVisible }">
        ...
        <div class="sidebar-content">
            ...
            <StyledButton :disabled="!loginStore.userLogged" :name="i18n.t('MySidebar.foodCombo')" @click="router.push({ name: 'foodCombo' })" />
            ...
            <StyledButton :disabled="!loginStore.userLogged" :name="i18n.t('MySidebar.fitbit')" @click="router.push({ name: 'fitbit' })" />
