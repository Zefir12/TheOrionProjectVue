<template>
    <div class="stat-card">
        <div class="cog-icon" @click="emit('cogClicked')"><IconSettings :size="28" stroke-width="2" /></div>
        ...
        <ProgressBar class="custom-bar" :style="{ '--bar-color': props.color || '#045dc2' }" :mode="'determinate'" :show-value="true" :value="(props.value / props.treshold) * 100"
